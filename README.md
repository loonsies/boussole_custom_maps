...
- 
<span style="font-size:24px; font-weight:bold;">DO NOT replace your whole settings.lua file content or it won't work. You need to add the entries from the settings.lua file from this repository to your own.</span>
